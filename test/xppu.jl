...
@testset "XPPU" begin
    ...
    maintain = MaintainLabels( [NeXLMatrixCorrection.bLabel, NeXLMatrixCorrection.ϕ0Label, NeXLMatrixCorrection.ϵLabel, NeXLMatrixCorrection.FLabel ], aϵ_res)
    ...
    coatingData = uvs( #
        ...
        NeXLMatrixCorrection.μoρLabel(coatU, cxr)=>uv(11705.,2185.)  # n"O K-L3" in n"C"
     )
